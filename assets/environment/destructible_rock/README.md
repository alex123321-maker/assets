...
Семейство статических воксельных ассетов для **Cube Siege** (oxel_static), предназначенное для разрушаемых природных ресурсов в игровом мире, доведённое до визуального качества утверждённого концепт-арта (
eferences/rock_concept_reference.png).
...
|---|---|:---:|:---:|:---:|:---:|
| **Stage 1** | Огромный целый валун | **6** | 727 – 900 | 1444 – 1596 | до 4 |
| **Stage 2** | Большой частично разрушенный камень | **3** | 454 – 576 | 988 – 1136 | до 4 |
| **Stage 3** | Средний камень / крупный остаток | **3** | 202 – 268 | 536 – 560 | до 4 |
| **Stage 4** | Небольшая группа крупных обломков | **2** | 126 – 134 | 432 – 492 | до 4 |
| **Stage 5** | Россыпь мелких обломков и гальки | **3** | 33 – 38 | 212 – 232 | до 3 |
| **Итого** | | **17** | | | |
...
- manifest.json — метаданные, тип oxel_static, бюджеты (max 4 materials, max 5000 tris);
- 
equest.md — описание варианта;
- source/voxels.json — канонический воксельный источник;
- output/model.glb — готовый для Godot меш;
- 
eview/ — ракурсы (iso, ront, side, 	op), metrics.json, 
eview.md.
