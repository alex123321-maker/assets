...
`tree_concept_reference.png` — утверждённый Арт-директором (Пользователем) официальный визуальный ориентир семейства для Issue #5. Он визуализирует ключевое художественное направление игры Cube Siege:
