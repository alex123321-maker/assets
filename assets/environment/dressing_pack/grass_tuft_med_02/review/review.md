...
- [x] Export validated (model.glb, glTF 2.0, 18264 bytes, 1 mesh, 1 shared material).
...
- [x] Internal faces culled (125 visible faces).
...
- Exported mesh AABB: 0.630m x 0.400m x 0.363m
- Exported bounds: min=[-0.201, 0.000, -0.212], max=[0.429, 0.400, 0.151]
