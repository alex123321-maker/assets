...
- [x] Export validated (model.glb, glTF 2.0, 12216 bytes, 1 mesh, 1 shared material).
...
- [x] Triangle count verified (144 tris <= 500 budget).
- [x] Internal faces culled (72 visible faces).
...
- World dimensions: 0.60m x 0.40m x 0.50m
