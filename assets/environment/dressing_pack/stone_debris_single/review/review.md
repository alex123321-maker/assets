...
- [x] Export validated (model.glb, glTF 2.0, 6844 bytes, 1 mesh, 1 shared material).
...
- [x] Triangle count verified (68 tris <= 500 budget).
- [x] Internal faces culled (33 visible faces).
