...
- [x] Export validated (model.glb, glTF 2.0, 16052 bytes, 1 mesh, 1 shared material).
...
- [x] Triangle count verified (196 tris <= 500 budget).
- [x] Internal faces culled (109 visible faces).
...
- Exported mesh AABB: 0.324m x 0.400m x 0.457m
- Exported bounds: min=[-0.162, 0.000, -0.162], max=[0.162, 0.400, 0.295]
