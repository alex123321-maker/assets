...
- [x] Export validated (model.glb, glTF 2.0, 24312 bytes, 1 mesh, 1 shared material).
...
- [x] Triangle count verified (324 tris <= 500 budget).
- [x] Internal faces culled (162 visible faces).
...
- Nominal grid size: 0.50m x 0.30m x 0.50m
- Exported mesh AABB: 0.382m x 0.301m x 0.400m
- Exported bounds: min=[-0.146, 0.000, -0.250], max=[0.236, 0.301, 0.150]
