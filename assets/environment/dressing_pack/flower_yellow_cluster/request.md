# Request: Yellow Flower Cluster (Sunny Buttercups)

## Metadata
- **Asset Name**: `flower_yellow_cluster`
- **Subfamily**: Flowers
...
## Role & Description
Golden yellow buttercup cluster with warm amber centers.
...
- Shared palette `flowers` integration;
