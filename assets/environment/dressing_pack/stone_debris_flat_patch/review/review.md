...
- [x] Export validated (model.glb, glTF 2.0, 14416 bytes, 1 mesh, 1 shared material).
...
- [x] Triangle count verified (188 tris <= 500 budget).
- [x] Internal faces culled (80 visible faces).
