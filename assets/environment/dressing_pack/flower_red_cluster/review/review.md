...
- [x] Export validated (model.glb, glTF 2.0, 18584 bytes, 1 mesh, 1 shared material).
...
- [x] Triangle count verified (236 tris <= 500 budget).
- [x] Internal faces culled (118 visible faces).
