...
- [x] Export validated (model.glb, glTF 2.0, 11640 bytes, 1 mesh, 1 shared material).
...
- [x] Triangle count verified (136 tris <= 500 budget).
- [x] Internal faces culled (68 visible faces).
