...
- [x] Export validated (model.glb, glTF 2.0, 19888 bytes, 1 mesh, 1 shared material).
...
- [x] Triangle count verified (262 tris <= 500 budget).
- [x] Internal faces culled (124 visible faces).
...
- Nominal grid size: 0.60m x 0.20m x 0.60m
- Exported mesh AABB: 0.500m x 0.200m x 0.600m
- Exported bounds: min=[-0.200, 0.000, -0.300], max=[0.300, 0.200, 0.300]
