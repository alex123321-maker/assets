...
- [x] Export validated (model.glb, glTF 2.0, 16364 bytes, 1 mesh, 1 shared material).
...
- [x] Triangle count verified (204 tris <= 500 budget).
- [x] Internal faces culled (102 visible faces).
