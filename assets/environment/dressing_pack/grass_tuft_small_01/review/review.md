...
- [x] Export validated (model.glb, glTF 2.0, 8576 bytes, 1 mesh, 1 shared material).
...
- [x] Triangle count verified (92 tris <= 500 budget).
- [x] Internal faces culled (46 visible faces).
