# Request: Tall Grass Tuft 01 (Accent Focal Clump)

## Metadata
- **Asset Name**: `grass_tuft_tall_01`
...
## Role & Description
Tall prominent focal grass clump with towering center spire.
...
- Shared palette `grass` integration;
