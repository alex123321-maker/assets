...
- [x] Export validated (model.glb, glTF 2.0, 22304 bytes, 1 mesh, 1 shared material).
...
- [x] Triangle count verified (300 tris <= 500 budget).
- [x] Internal faces culled (165 visible faces).
...
- Grid dimensions: 5x6x5 (voxel_size: 0.1m)
- Nominal grid size: 0.50m x 0.60m x 0.50m
- Exported mesh AABB: 0.588m x 0.600m x 0.590m
- Exported bounds: min=[-0.294, 0.000, -0.295], max=[0.294, 0.600, 0.295]
