...
- [x] Export validated (model.glb, glTF 2.0, 16920 bytes, 1 mesh, 1 shared material).
...
- [x] Triangle count verified (212 tris <= 500 budget).
- [x] Internal faces culled (106 visible faces).
...
- World dimensions: 0.50m x 0.60m x 0.50m
