...
- [x] Export validated (model.glb, glTF 2.0, 15248 bytes, 1 mesh, 1 shared material).
...
- [x] Triangle count verified (194 tris <= 500 budget).
- [x] Internal faces culled (90 visible faces).
...
- Exported mesh AABB: 0.500m x 0.400m x 0.400m
- Exported bounds: min=[-0.250, 0.000, -0.250], max=[0.250, 0.400, 0.150]
