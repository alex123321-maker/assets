...
class AgentResumer:
    ...
    def build_prompt(
        ...
        prompt = RESUME_PROMPT_TEMPLATE.format(pr_number=pr_number, visual_media_policy=VISUAL_MEDIA_POLICY)
    ...
    def prepare_dispatch_prompt(self, pr_number: int, prompt: str) -> str:
        ...
        return (
            ...
            "or submit reviews/status comments. Publish the visual attachment packet as "
            "instructed in the task file, with the required agent marker. Report results in this conversation."
        )
