...
MATERIALS = [
    ...
    },
    {
        ...
        "roughness": 0.92,
        "color_desc": "Stratified horizontal beds (#44413e / #524e4a), relief depth",
    },
    {
...
def generate_metrics_summary() -> Path:
    ...
    metrics = {
        ...
        "textures": {
            "forest_grass_top": {"resolution": [16, 16], "roughness": 0.85, "tileability_test": "PASS (6x6 verified)", "format": "RGBA8"},
            "plains_meadow_top": {"resolution": [16, 16], "roughness": 0.85, "tileability_test": "PASS (6x6 verified)", "format": "RGBA8"},
            "mountain_stone_top": {"resolution": [16, 16], "roughness": 0.90, "tileability_test": "PASS (6x6 verified)", "format": "RGBA8"},
            "cliff_side": {"resolution": [16, 16], "roughness": 0.92, "tileability_test": "PASS (6x6 verified)", "format": "RGBA8"},
            "dirt_soil": {"resolution": [16, 16], "roughness": 0.92, "tileability_test": "PASS (6x6 verified)", "format": "RGBA8"},
        },
        "atlas": {
...
def generate_review_md() -> Path:
    """Generate family review.md documenting visual self-review and objective verification."""
    review_content = """# Family Self Review: Terrain Material Kit (Issue #6)
...
"""
    out_file = REVIEW_DIR / "review.md"
    out_file.write_text(review_content, encoding="utf-8")
    print(f"[SAVED] {out_file}")
    return out_file
