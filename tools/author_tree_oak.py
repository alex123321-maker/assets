...
|:---:|---|---|:---:|:---:|:---:|---|
| **0** | **Standard Oak** | `var_0_standard_oak` | {summary[0]['grid']} | {summary[0]['dimensions_m']} | {summary[0]['occupied_voxels']} | Базовое взрослое дерево; ствол с контрфорсными корнями, видимые сучья, 3 асимметричные массы кроны. |
